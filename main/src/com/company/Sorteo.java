...
public class Sorteo {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 74; i++) {
            if(s[i]) System.out.println(temes[i]);
        }
    }
    ...
    static String[] temes = {
            ...
            , "48. Ingeniería del software. Ciclo de desarrollo del software. Tipos de ciclos de desarrollo. Metodologías de desarrollo. Características distintivas de las principales metodologías de desarrollo utilizadas en la UE         "
